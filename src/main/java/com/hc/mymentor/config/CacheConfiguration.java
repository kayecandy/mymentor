package com.hc.mymentor.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hc.mymentor.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hc.mymentor.repository.UserRepository.USERS_BY_EMAIL_CACHE);
